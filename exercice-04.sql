...
SELECT * FROM project INNER JOIN student on student.project_id = project.id
-- Exo 4.4
-- Listez le project dont l'id est `3` avec ses students
SELECT * FROM project INNER JOIN student on student.project_id = project.id WHERE project.id = 3
