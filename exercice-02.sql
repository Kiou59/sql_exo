...
VALUES (NULL,'Promo 2023','La promo de 2023','2023-03-15',NULL);
-- Exo 2.3
...
UPDATE `tag` SET `id`='1',`name`='HTML',`description`='Le HTML est un language de structuration de données.'
WHERE id = 1;
-- Exo 2.5
-- Mettez à jour le tag `Bash` :
-- nom : Terminal Bash
-- description : Le terminal Bash est l'interface en ligne de commande par défaut sous Linux.
UPDATE `tag` SET `id`='10',`name`='Terminal Bash',`description`='Le terminal Bash est l''interface en ligne de commande par défaut sous Linux.'
WHERE id = 10;
-- Exo 2.6
...
-- - projet : Ut delectus explicabo. id=16
